...
pub struct ResourceSpans {
    ...
    pub resource: Option<super::super::resource::v1::Resource>,
...
pub struct ScopeSpans {
    ...
    pub scope: Option<super::super::common::v1::InstrumentationScope>,
...
pub mod span {
    ...
    pub struct Event {
        ...
        /// Attribute keys MUST be unique (it is not allowed to have more than one
        /// attribute with the same key).
        pub attributes: Option<Vec<super::super::super::common::v1::KeyValue>>,
