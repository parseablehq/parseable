...
pub fn get_querier_info() -> anyhow::Result<QuerierMetadata> {
...
pub fn put_querier_info(info: QuerierMetadata) -> anyhow::Result<()> {
    let path = PathBuf::from(&CONFIG.parseable.local_staging_path);
